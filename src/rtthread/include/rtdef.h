 ...
 * 2023-01-07     Yanye        remove RT-Thread thread and ipc object.
 */
...
enum rt_object_class_type
{
    ...
    RT_Object_Class_Memory        = 0x02,      /**< The object is a memory. */
    RT_Object_Class_Unknown       = 0x03,      /**< The object is unknown. */
