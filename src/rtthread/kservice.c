...
{
    rt_kprintf("RTXThread Operating System\n");
    rt_kprintf("Powered by RT-Thread and RTX5\n");
    rt_kprintf("Version info:\n");
    rt_kprintf("RT-Thread %d.%d.%d\n", RT_VERSION, RT_SUBVERSION, RT_REVISION);
    rt_kprintf("CMSIS RTOS2 API %d\n", osRtxVersionAPI);
    rt_kprintf("RTX Kernel %d\n", osRtxVersionKernel);
}
...
ALIGN(4) static osRtxMutex_t _lock_entity;
